const emailConfimLayout = (confirmLink) => {
    ...
    <html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
        ...
        <tbody>
          <tr>
            <td style="font-size:16px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
              <h2>PHONEBOOK</h2>
            </td>
          </tr>
        </tbody>
